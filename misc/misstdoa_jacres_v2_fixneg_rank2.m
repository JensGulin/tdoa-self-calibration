function [res,jac]=misstdoa_jacres_v2_fixneg_rank2(sol);
...
if 0,
    sol0 = sol;
    kk = 5; dz = zeros(141,1); dz(kk)=1;
    litet = 0.00001;
    sol1 = misstdoa_update_v2_rank2(sol,litet*dz);
    [res0,jac0]=misstdoa_jacres_v2_fixneg_rank2(sol0);
    [res1,jac1]=misstdoa_jacres_v2_fixneg_rank2(sol1);
    [(res1-res0)/litet jac0*dz]
  
    sol0 = sol;
    dz = randn(141,1); dz = dz/norm(dz);
    litet = 0.00001;
    sol1 = misstdoa_update_v2_rank2(sol,litet*dz);
    [res0,jac0]=misstdoa_jacres_v2_fixneg_rank2(sol0);
    [res1,jac1]=misstdoa_jacres_v2_fixneg_rank2(sol1);
    ...
    for kk = 1:128,
        ...
        [res0,jac0]=misstdoa_jacres_v2_rank2(sol0);
        [res1,jac1]=misstdoa_jacres_v2_rank2(sol1);
        [(res1-res0)/litet jac0*dz]
        kk
        pause;
...
%
% internal
in = -2*sol.u(I,1).*(sol.v(1,J)')  -2*sol.u(I,2).*(sol.v(2,J)') + sol.a(I)+sol.b(J)';
% residuals
...
dd2  = (ss).*(ones(M,1));
do2  = (ss).*(zeros(M,1));
DD2 = C*[dw12;dw22;dv12;dv22;dc2;dd2;do2];
